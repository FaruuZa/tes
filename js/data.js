...
const CARDS = {
  ...
  giant_skeleton: {
    ...
    tags: ["ground", "single", "heavy"],
    deathEffect: { type: "explode", dmg: 1000, radius: 4 },
    visuals: {
      scale: 1.4,
      skin: "#fff",
      head: "skull_giant",
  ...
  mega_knight: {
    ...
    tags: ["ground", "area", "heavy"],
    spawnEffect: { type: "damage", dmg: 350, radius: 2.5 },
    jumpAttack: { minRange: 3.5, maxRange: 5.0, dmg: 420, speed: 2 },
    visuals: {
      scale: 1.1,
      skin: "#37474f",
      head: "helmet_full",
  ...
  yeti: {
    ...
    stats: {
      ...
      slowAmount: 0.3,
      slowDuration: 1.5,
      spawnUnitKey: "ice_spirit",
      spawnInterval: 5,
      spawnCount: 1,
    },
    tags: ["ground", "area", "heavy", "slow-effect", "spawner"],
    visuals: {
      scale: 1.4,
      skin: "#e0f7fa",
      head: "fur_white",
  ...
  void_walker: {
    ...
    tags: ["ground", "single", "heavy"],
    // Mati meninggalkan zona Void yang memberikan damage terus menerus
    deathEffect: {
      type: "spell",
      spell: "void",
      radius: 3.5,
    ...
    desc: "Prajurit dimensi lain. Meninggalkan lubang Void mematikan saat mati.",
  },
  ...
  storm_caller: {
    ...
    // Unit terbang yang menyetrum area (mirip E-Wiz tapi terbang)
    visuals: {
      scale: 1.1,
      skin: "#b3e5fc",
      head: "hair_spiky",
    ...
    desc: "Penguasa badai dari langit. Serangannya menyetrum area musuh.",
  },
  ...
  magma_titan: {
    ...
    tags: ["ground", "building-hunter", "heavy"],
    // Muncul meledak (Damage), Mati memanggil Meteor
    spawnEffect: { type: "damage", dmg: 300, radius: 3.0 },
    deathEffect: {
      type: "spell",
      spell: "meteor",
      radius: 3.5,
    ...
    desc: "Raksasa magma. Membakar saat muncul, memanggil meteor saat hancur.",
  },
  ...
  phantom_lancer: {
    ...
    tags: ["ground", "single", "shielded", "charge", "fast"],
    // Unit hantu dengan shield tebal & charge damage (Prince versi hantu)
    visuals: {
      scale: 1.0,
      skin: "#eceff1",
      head: "hood_ninja",
    ...
    desc: "Hantu berkuda. Charge damage mematikan dan dilindungi perisai roh.",
  },
  ...
  chrono_mage: {
    ...
    desc: "Memanipulasi waktu. Memperlambat musuh secara drastis (60%).",
  },
  ...
  tesla: {
    ...
    tags: ["air-target", "hide-when-idle"],
    color: "#0288d1",
  },
  inferno_tower: {
    name: "Inferno",
  ...
  fireball: {
    ...
    icon: "🔥",
    type: "spell",
    stats: { dmg: 549, radius: 2.5, spawnDelay: 1.0 },
  },
  arrows: {
    name: "Arrows",
    cost: 3,
    icon: "🏹",
    type: "spell",
    stats: { dmg: 288, radius: 4.0, spawnDelay: 0.8 },
  },
  zap: {
    name: "Zap",
    cost: 2,
    icon: "⚡",
    type: "spell",
    stats: { dmg: 1, radius: 2.5, stunDuration: 0.5, spawnDelay: 0.5 },
  },
  rage: {
    name: "Rage",
    cost: 2,
  ...
  freeze: {
    ...
    icon: "❄️",
    type: "spell",
    stats: { dmg: 1, radius: 4.0, stunDuration: 4, spawnDelay: 0.5 },
  },
  rocket: {
    name: "Rocket",
    cost: 6,
    icon: "🚀",
    type: "spell",
    stats: { dmg: 940, radius: 2.0, spawnDelay: 2.0 },
  },
  the_log: {
    name: "The Log",
    cost: 2,
  ...
  goblin_barrel: {
    ...
    icon: "🛢️",
    type: "spell",
    stats: { count: 3, spawnUnit: "goblins", spawnDelay: 1.5, spawnRadius: 50 },
  },
  lightning: {
    name: "Lightning",
    cost: 6,
    icon: "🌩️",
    type: "spell",
    stats: { dmg: 799, radius: 3.5, stunDuration: 0.5, spawnDelay: 1.0 },
  },
  earthquake: {
    name: "Earthquake",
    cost: 3,
    icon: "🌋",
    type: "spell",
    stats: { dmg: 200, radius: 4.0, spawnDelay: 0.5 },
  },
  void: {
    name: "Void",
    cost: 3,
    icon: "🌌",
    type: "spell",
    stats: { dmg: 384, radius: 3.0, spawnDelay: 1.0 },
  },
  meteor: {
    name: "Meteor",
    cost: 5,
    icon: "☄️",
    type: "spell",
    stats: { dmg: 846, radius: 3.5, spawnDelay: 2.5 },
  },
  ...
  golemite: {
    ...
    tags: ["ground", "building-hunter"],
    color: "#8d6e63",
    hiddenInDeck: true,
    deathEffect: { type: "explode", dmg: 100, radius: 2.0 },
    visuals: {
      scale: 0.8,
      skin: "#8d6e63",
      head: "rock",
  ...
  storm_druid: {
    ...
    tags: ["ground", "area", "air-target", "slow-effect"],
    spawnEffect: { type: "zap", radius: 2.5, dmg: 80 },
    visuals: {
      head: "antlers",
      body: "robe_green",
      weapon: "magic_zap",
    ...
    desc: "Penyihir alam yang memanggil petir dan memperlambat musuh.",
  },
  ...
  bone_ram: {
    ...
    tags: ["ground", "single", "charge", "fast"],
    visuals: {
      head: "skull_giant",
      body: "ribs_armor",
      weapon: "horn",
    ...
    desc: "Makhluk tulang berlari kencang dan menghantam dengan charge mematikan.",
  },
  ...
  ember_monk: {
    ...
    desc: "Biksu api yang memukul tanah dan membakar area sekitar.",
  },
  ...
  iron_sentinel: {
    ...
    tags: ["ground", "single", "heavy", "shielded"],
    visuals: {
      head: "helmet_full",
      body: "armor_heavy",
      weapon: "mace_hands",
    ...
    desc: "Penjaga besi lambat namun hampir tak tergoyahkan.",
  },
  ...
  plague_thrower: {
    ...
    desc: "Pelempar racun yang melemahkan gerakan musuh.",
  },
  ...
  crystal_wyvern: {
    ...
    tags: ["air", "single", "air-target", "slow-effect"],
    visuals: {
      head: "lizard",
      body: "dragon",
      weapon: "spit_ice",
    ...
    desc: "Naga kristal udara dengan serangan dingin presisi.",
  },
  ...
  grave_engineer: {
    ...
    desc: "Insinyur kuburan yang meninggalkan pasukan tulang saat gugur.",
  },
  ...
  void_reaver: {
    ...
    desc: "Pendekar void yang menebas dengan energi kegelapan.",
  },
  ...
  sky_ballista: {
    ...
    tags: ["ground", "single", "air-target", "siege"],
    visuals: {
      head: "machine",
      body: "wood_mech",
      weapon: "cannon",
    ...
    desc: "Mesin panah jarak jauh khusus anti-udara.",
  },
  ...
  ashen_spirit: {
    ...
    tags: ["ground", "kamikaze", "area", "charge"],
    deathEffect: {
      type: "explode",
      dmg: 160,
      radius: 2.2,
    ...
    desc: "Roh abu yang meledak saat menyentuh musuh.",
  },
};
